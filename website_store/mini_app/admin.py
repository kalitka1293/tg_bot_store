...
from mini_app.models import Country, Product, ParameterProduct, SubcategoryProduct, TypeEquipment, Brand
...
class ProductAdmin(admin.ModelAdmin):
    ...
    fields = ('name','brand','price','cooling_power','heating_power',
